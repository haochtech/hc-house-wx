...
Page({
    ...
    onLoad: function(a) {
        ...
        wx.setNavigationBarTitle({
            title: "个人发布房屋出租-" + wx.getStorageSync("companyinfo").name
        });
    ...
    savepubinfo: function(a) {
        ...
        if (0 != o.data.isagree) {
            var e = a.detail.value.content, i = a.detail.value.name, s = a.detail.value.tel, n = this.data.areaid, r = this.data.special, l = wx.getStorageSync("cityinfo");
            if ("" != e) if (r) {
                                                            ...
                                                            console.log(a), wx.showToast({
                                                                ...
                                                                success: function(a) {
                                                                    console.log(a), wx.navigateTo({
                                                                        url: "/weixinmao_house/pages/mypub/index?id=2"
                                                                    });
                                                                }
                                                            });
                                                        },
