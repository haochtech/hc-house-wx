...
Page({
    ...
    oldhouseinit: function(a) {
        var t = this, e = wx.getStorageSync("cityinfo");
        app.util.request({
    ...
    doupload: function(a) {
        var e, i, o, s, n, r, l = this, d = parseInt(a.currentTarget.dataset.id);
        switch (d) {
          case 1:
        ...
        wx.chooseImage({
            ...
            success: function(a) {
                ...
                l.setData({
                    ...
                    true5: l.data.true5,
                    true6: l.data.true6
                }), l.data.imagelist.push(t), l.uploadimg(t, d);
            }
        });
    },
    ...
    savepubinfo: function(a) {
        ...
        if (0 != o.data.isagree) {
            var e = a.detail.value.content, i = a.detail.value.name, s = a.detail.value.tel, n = this.data.areaid, r = this.data.special;
            console.log(this.data.areaid);
            var l = wx.getStorageSync("cityinfo");
            if ("" != e) if (r) {
                var d = this.data.uploadimagelist;
                if (d.length < 2) wx.showModal({
                    title: "提示",
                    content: "上传图片不少于2张",
                    showCancel: !1
                }); else if ("" != i) if ("" != s) if (0 != n) {
                    var u = d.join("@"), c = this.data.toplistid;
                    if (-1 != c) {
                        var p = {
                            sessionid: t.sessionid,
                            uid: t.memberInfo.uid,
                            uploadimagelist_str: u,
                            content: e,
                            special: r,
                            name: i,
                            tel: s,
                                                            ...
                                                            console.log(a), wx.showToast({
                                                                ...
                                                                success: function(a) {
                                                                    console.log(a), wx.navigateTo({
                                                                        url: "/weixinmao_house/pages/mypub/index?id=1"
                                                                    });
                                                                }
                                                            });
                                                        },
